...
<details>
  ...
  <ul>
    <li><a href="https://ruby-doc.org/3.1.3/">Ruby</a></li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone git@github.com:uisendy/Decode-Morse-code.git
```
...
- [ ] **Creating the morse decoder to accept input and GUI outputs**
...
I would like to thank Microverse and My team for the learning and tutors.
